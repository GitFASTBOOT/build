...
$(cts_interactive_jar_files): PRIVATE_API_MAP_FILES := $(sort $(COMPATIBILITY.cts-verifier.API_MAP_FILES) \
                                                              $(COMPATIBILITY.cts-interactive.API_MAP_FILES))
$(cts_interactive_jar_files):
	mkdir -p $(dir $@)
	echo $(PRIVATE_API_MAP_FILES) > $@

$(cts_all_jar_files): PRIVATE_API_MAP_FILES := $(sort $(COMPATIBILITY.cts.API_MAP_FILES) \
                                                      $(COMPATIBILITY.cts-interactive.API_MAP_FILES) \
                                                      $(COMPATIBILITY.cts-verifier.API_MAP_FILES))
$(cts_all_jar_files):
	mkdir -p $(dir $@)
	echo $(PRIVATE_API_MAP_FILES) > $@
